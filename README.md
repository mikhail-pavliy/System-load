...
1. grub.sh добавляет репозиторий с пропатченным grub и обновляет его
2. fsmove.sh создает lvm на доп. диске переносит туда файлы системы с текущего lvm + boot раздел, далее в chroot на новом разделе меняет fstab, устанавливает grub на новый 
